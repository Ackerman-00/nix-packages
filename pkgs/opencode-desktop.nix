...
let
  ...
  archives = {
    ...
    aarch64-linux = pkgs.fetchurl {
      url = "https://github.com/anomalyco/opencode/releases/download/${version}/opencode-desktop-linux-arm64.deb";
      hash = "sha256-upmanTFNq7ye1/SoPH4rGhHIBaHwS9q8pdO3/ZScfHU=";
    };
  };
in
