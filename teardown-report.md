...
|---|---|---|---|---|---|
| helium | helium-0.16.1.1-x86_64_linux.tar.xz | 0.16.1.1 | 0.16.1.1 | **OK** | tar runtime probe chrome --version: Helium 0.16.1.1 (Chromium 152.0.7977.64) \| pinned 0.16.1.1 \| internal 0.16.1.1 |
| helium | helium-0.16.1.1-arm64_linux.tar.xz | 0.16.1.1 |  | **SOURCE-OK** | tar extracted, no version evidence found \| hash hash-OK \| source tarball (version = PV by construction) |
...
| protonplus | ProtonPlus-0.6.4-anylinux-aarch64.AppImage | 0.6.4 |  | **OK** | AppImage teardown error: [Errno 8] Exec format error: '/tmp/opencode/sweep-test2/distfiles/ProtonPlus-0.6.4-anylinux-aarch64.AppImage' \| hash hash-OK \| cross-arch artifact (aarch64), hash-verified; not executable on x86_64 host |
| rootapp | Root.AppImage | 0.9.128 | 0.9.128 | **OK** | AppImage 0.9.128 (Root.desktop) \| pinned 0.9.128 \| internal 0.9.128 |
| rootapp | Root.AppImage | 0.9.128 |  | **OK** | AppImage teardown error: [Errno 8] Exec format error: '/tmp/opencode/sweep-test2/distfiles/Root_2.AppImage' \| hash hash-OK \| cross-arch artifact (aarch64), hash-verified; not executable on x86_64 host |
...
| helium | upstream github.com/imputnet/helium-linux | 0.16.1.1 | 0.16.1.1 | **OK** | at upstream latest 0.16.1.1 [releases/latest] |
