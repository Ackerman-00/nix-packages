...
| rootapp | Root.AppImage | 0.9.129 |  | **OK** | AppImage teardown error: [Errno 8] Exec format error: '/tmp/opencode/sweep-current/distfiles/Root_3.AppImage' \| hash hash-OK \| cross-arch artifact (aarch64), hash-verified; not executable on x86_64 host |
...
| rootapp | rootapp | 0.9.129 | 0.9.128 | **OUTDATED** | upstream 0.9.128 available, use nix-update (auto-update versions + hashes, test build) |
