...
| opencode-desktop | opencode-desktop-linux-amd64.deb | v1.18.21 | 1.18.21 | **OK** | deb pkg=opencode (control control.tar.xz) \| pinned v1.18.21 \| internal 1.18.21 |
| opencode-desktop | opencode-desktop-linux-arm64.deb | v1.18.21 | 1.18.21 | **OK** | deb pkg=opencode (control control.tar.xz) \| pinned v1.18.21 \| internal 1.18.21 |
...
| rootapp | Root.AppImage | latest |  | **OK** | AppImage teardown error: [Errno 8] Exec format error: '/tmp/teardown-sweep/distfiles/Root_7.AppImage' \| hash hash-OK \| cross-arch artifact (aarch64), hash-verified; not executable on x86_64 host |
...
| opencode-desktop | upstream github.com/anomalyco/opencode | v1.18.21 | v1.18.21 | **OK** | at upstream latest v1.18.21 [releases/latest] |
