...
|---|---|---|---|---|---|
| helium | helium-0.16.3.1-x86_64_linux.tar.xz | 0.16.3.1 |  | **SOURCE-OK** | tar extracted, no version evidence found \| hash hash-OK \| source tarball (version = PV by construction) |
...
| protonplus | ProtonPlus-0.6.5-anylinux-aarch64.AppImage | 0.6.5 |  | **OK** | AppImage teardown error: [Errno 8] Exec format error: '/workdir/distfiles/ProtonPlus-0.6.5-anylinux-aarch64.AppImage' \| hash hash-OK \| cross-arch artifact (aarch64), hash-verified; not executable on x86_64 host |
| rootapp | Root.AppImage | 0.9.128 | 0.9.128 | **OK** | AppImage 0.9.128 (Root.desktop) \| pinned 0.9.128 \| internal 0.9.128 |
| rootapp | Root.AppImage | 0.9.128 |  | **OK** | AppImage teardown error: [Errno 8] Exec format error: '/workdir/distfiles/Root_3.AppImage' \| hash hash-OK \| cross-arch artifact (aarch64), hash-verified; not executable on x86_64 host |
