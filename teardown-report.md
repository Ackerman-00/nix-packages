...
| mixtapes | live m-obeid/Mixtapes | b2716b2ef6ed | b2716b2ef6ed | **OK** | live m-obeid/Mixtapes pin b2716b2ef6ed vs upstream b2716b2ef6ed |
| opencode-desktop | opencode-desktop-linux-amd64.deb | 1.18.28 | 1.18.28 | **OK** | deb pkg=opencode (control control.tar.xz) \| pinned 1.18.28 \| internal 1.18.28 |
| opencode-desktop | opencode-desktop-linux-arm64.deb | 1.18.28 | 1.18.28 | **OK** | deb pkg=opencode (control control.tar.xz) \| pinned 1.18.28 \| internal 1.18.28 |
...
| protonplus | ProtonPlus-0.6.5-anylinux-aarch64.AppImage | 0.6.5 |  | **OK** | AppImage teardown error: [Errno 8] Exec format error: '/tmp/opencode/sweep-verify/distfiles/ProtonPlus-0.6.5-anylinux-aarch64.AppImage' \| hash hash-OK \| cross-arch artifact (aarch64), hash-verified; not executable on x86_64 host |
...
| helium | upstream github.com/imputnet/helium-linux | 0.16.4.1 | 0.16.4.1 | **OK** | at upstream latest 0.16.4.1 [releases/latest] |
| opencode-desktop | upstream github.com/anomalyco/opencode | 1.18.28 | v1.18.28 | **OK** | at upstream latest v1.18.28 [releases/latest] |
