...
| protonplus | ProtonPlus-0.6.8-anylinux-aarch64.AppImage | 0.6.8 |  | **OK** | AppImage teardown error: [Errno 8] Exec format error: '/tmp/opencode/sweep-34689081628/distfiles/ProtonPlus-0.6.8-anylinux-aarch64.AppImage' \| hash hash-OK \| cross-arch artifact (aarch64), hash-verified; not executable on x86_64 host |
| rootapp | Root.AppImage | 0.9.130 | 0.9.130 | **OK** | AppImage 0.9.130 (Root.desktop) \| pinned 0.9.130 \| internal 0.9.130 |
| rootapp | Root.AppImage | 0.9.130 |  | **OK** | AppImage teardown error: [Errno 8] Exec format error: '/tmp/opencode/sweep-34689081628/distfiles/Root_2.AppImage' \| hash hash-OK \| cross-arch artifact (aarch64), hash-verified; not executable on x86_64 host |
