...
| rootapp | Root.AppImage | latest |  | **OK** | AppImage teardown error: [Errno 8] Exec format error: '/tmp/teardown-sweep/distfiles/Root_8.AppImage' \| hash hash-OK \| cross-arch artifact (aarch64), hash-verified; not executable on x86_64 host |
