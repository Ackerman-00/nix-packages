...
| protonplus | ProtonPlus-0.6.4-anylinux-aarch64.AppImage | 0.6.4 |  | **OK** | AppImage teardown error: [Errno 8] Exec format error: '/tmp/teardown-sweep-32741126292/distfiles/ProtonPlus-0.6.4-anylinux-aarch64.AppImage' \| hash hash-OK \| cross-arch artifact (aarch64), hash-verified; not executable on x86_64 host |
| rootapp | Root.AppImage | 0.9.127 | 0.9.127 | **OK** | AppImage 0.9.127 (Root.desktop) \| pinned 0.9.127 \| internal 0.9.127 |
| rootapp | Root.AppImage | 0.9.127 |  | **OK** | AppImage teardown error: [Errno 8] Exec format error: '/tmp/teardown-sweep-32741126292/distfiles/Root_2.AppImage' \| hash hash-OK \| cross-arch artifact (aarch64), hash-verified; not executable on x86_64 host |
