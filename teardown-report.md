...
|---|---|---|---|---|---|
| helium | helium-0.16.2.1-x86_64_linux.tar.xz | 0.16.2.1 | 0.16.2.1 | **OK** | tar runtime probe chrome --version: Helium 0.16.2.1 (Chromium 152.0.7977.64) \| pinned 0.16.2.1 \| internal 0.16.2.1 |
| helium | helium-0.16.2.1-arm64_linux.tar.xz | 0.16.2.1 |  | **SOURCE-OK** | tar extracted, no version evidence found \| hash hash-OK \| source tarball (version = PV by construction) |
...
| helium | upstream github.com/imputnet/helium-linux | 0.16.2.1 | 0.16.2.1 | **OK** | at upstream latest 0.16.2.1 [tag; releases/latest pointer stale at 0.16.1.1] |
